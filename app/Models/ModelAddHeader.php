...
class ModelAddHeader extends Model
{
    protected $table = 'tpoheader'; // Replace with your actual table name
    
    protected $primaryKey = 'PK_tpoheader';
    protected $allowedFields = ['PoNo', 'PoNumber','KodeDept', 'PersonInCharge', 'PoDate', 'Delivery', 'ref', 'ShipmentLoc', 'ShipmentTerms', 'VendorNo', 'MataUang', 'TermsOfPayment', 'InWord', 'NilaiDalamRp'];
