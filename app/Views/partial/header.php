...
<nav class="navbar navbar-expand-lg navbar-dark text-light" style="background-color:#027fb3;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo site_url('Add')?>" class="nav-link <?php if($activeMenu == 'Add')  ?>">Add <i class="bi bi-plus-lg"></i></a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="<?php echo site_url('Add_Spk/NewWorkOrder')?>" class="nav-link <?php if($activeMenu == 'Add')  ?>">Add</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo site_url('Goods_SPK')?>" class="nav-link <?php if($activeMenu == 'Goods_SPK')  ?>">Purchase Requisition <i class="bi bi-plus-lg"></i></a>
          <a class="dropdown-item" href="<?php echo site_url('Add_Spk')?>" class="nav-link <?php if($activeMenu == 'PreOrder')  ?>">List Of Goods & Services</a>
        </div>
      </li>
    </ul>
    ...
    <li class="nav-item active">
    <div class="dropdown">
    <button class="btn dropdown-toggle btn-dark" style="background-color: #027fb3;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
